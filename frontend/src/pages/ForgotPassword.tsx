  ...
  return (
    <div className="flex min-h-screen w-full overflow-hidden font-body bg-surface">
      ...
      <div className="w-full md:w-1/2 relative flex items-center justify-center p-8 bg-surface-container-lowest overflow-y-auto min-h-screen">
          ...
          {!submitted ? (
            <>
              ...
              <div className="text-center md:text-left mb-8">
                 <div className="w-12 h-12 bg-blue-50/10 dark:bg-blue-500/10 flex items-center justify-center rounded-xl mb-6 shadow-sm">
                 ...
                 <p className="text-sm text-on-surface-variant font-medium">Enter your university email to receive a secure password reset link.</p>
              </div>

              <form onSubmit={handleSubmit} className="space-y-6">

                <div className="space-y-2">
                  <label className="text-xs font-bold text-on-surface ml-1">University Email</label>
                  <div className="relative group">
                     ...
                     <input 
                       ...
                       className="w-full bg-surface-container border border-outline-variant/30 rounded-xl px-4 py-3.5 pl-11 text-sm font-medium text-on-surface outline-none transition-all duration-300 focus:bg-surface-container-lowest focus:border-blue-500 focus:ring-4 focus:ring-blue-500/5 placeholder:text-gray-300"
                ...
                <div className="text-center">
                   <Link to="/login" className="inline-flex items-center gap-2 text-sm font-bold text-on-surface-variant hover:text-blue-600 transition-colors group">
            ...
            <div className="text-center py-12 animate-fade-in">
               <div className="w-20 h-20 bg-green-50/10 flex items-center justify-center rounded-full mb-8 shadow-sm mx-auto">
                ...
                <h2 className="text-3xl font-display font-bold text-on-surface mb-4">Check your email</h2>
        ...
        <div className="absolute bottom-6 left-0 right-0 flex justify-center gap-8 text-[10px] uppercase tracking-widest text-[#c4c6cf] font-black transition-all">
